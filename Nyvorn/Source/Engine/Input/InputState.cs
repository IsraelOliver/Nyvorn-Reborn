...
namespace Nyvorn.Source.Engine.Input
{
    public readonly struct InputState
    {
        ...
        public bool UseSelectedItemPressed { get; }
        ...
        public InputState(int moveDir, bool jumpPressed, bool attackPressed, bool useSelectedItemPressed, bool openInventoryPressed, bool openPausePressed, int hotbarSelectionIndex, bool dodgePressed, int dodgeDir, Vector2 mouseScreenPosition)
        {
            MoveDir = moveDir;
            JumpPressed = jumpPressed;
            AttackPressed = attackPressed;
            UseSelectedItemPressed = useSelectedItemPressed;
        ...
        {
            return new InputState(MoveDir, JumpPressed, false, false, OpenInventoryPressed, OpenPausePressed, HotbarSelectionIndex, DodgePressed, DodgeDir, MouseScreenPosition);
        }
    }
}
